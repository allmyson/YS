    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            //on preview select change
                ...
                List<LocalMedia> images = (List<LocalMedia>) data.getSerializableExtra(ImagePreviewActivity
                        .OUTPUT_LIST);
                if (isDone) {
                    onSelectDone(images);
                } else {
    ...
    public void startCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {//android-7.0
                ...
                Uri contentUri = FileProvider.getUriForFile(this, authority, cameraFile);
