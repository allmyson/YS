...
public class Dhzs_heFragment extends BaseZSFragment {
    ...
    public static Dhzs_heFragment newInstance(List<ResultBean.DataBean> list) {
        Dhzs_heFragment fragment = new Dhzs_heFragment();
        fragment.list = list;
        return fragment;
    }
...
//    }
    ...
    private void getDefaultData() {
        List<List<Integer>> list100 = getHEList(list);
        List<List<Integer>> list50 = new ArrayList<>();
        List<List<Integer>> list30 = new ArrayList<>();
