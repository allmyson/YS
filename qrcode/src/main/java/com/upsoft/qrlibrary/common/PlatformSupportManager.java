...
package com.upsoft.qrlibrary.common;
 ...
 * API level.</p>
 *
 * <p>This class manages that process. Subclasses of this class manage access to implementations of a given interfaces
 ...
 *
 * @param <T> the interfaces which managed implementations implement
 */
